package org.example.gyeonggipartners.domain.message.application;

import lombok.RequiredArgsConstructor;
import lombok.extern.slf4j.Slf4j;
import org.example.gyeonggipartners.common.exception.BusinessException;
import org.example.gyeonggipartners.common.exception.MessageException;
import org.example.gyeonggipartners.domain.discussionroom.exception.DiscussionRoomErrorCode;
import org.example.gyeonggipartners.domain.discussionroom.infra.persistence.discussionRoom.DiscussionRoomEntity;
import org.example.gyeonggipartners.domain.discussionroom.infra.persistence.discussionRoom.DiscussionRoomJpaRepository;
import org.example.gyeonggipartners.domain.discussionroom.infra.persistence.member.MemberJpaRepository;
import org.example.gyeonggipartners.domain.message.api.MessageType;
import org.example.gyeonggipartners.domain.message.api.dto.MessagePageResponse;
import org.example.gyeonggipartners.domain.message.api.dto.MessageRequest;
import org.example.gyeonggipartners.domain.message.api.dto.MessageResponse;
import org.example.gyeonggipartners.domain.message.exception.MessageErrorCode;
import org.example.gyeonggipartners.domain.message.infra.MessageEntity;
import org.example.gyeonggipartners.domain.message.infra.MessageRepository;
import org.example.gyeonggipartners.domain.user.exception.UserErrorCode;
import org.example.gyeonggipartners.domain.user.infra.persistence.UserEntity;
import org.example.gyeonggipartners.domain.user.infra.persistence.UserJpaRepository;
